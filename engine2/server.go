...
<body>
    <div class="container">
        ...
        <p>à¤¹à¤° à¤¸à¥à¤Ÿà¥‡à¤ª à¤•à¥‡ à¤²à¤¿à¤ à¤¡à¥‡à¤¡à¤¿à¤•à¥‡à¤Ÿà¥‡à¤¡ à¤¬à¤Ÿà¤¨à¥¤ à¤—à¤¿à¤Ÿà¤¹à¤¬ à¤²à¤¿à¤‚à¤• à¤¡à¤¾à¤²à¥‹ à¤”à¤° à¤•à¤‚à¤Ÿà¥à¤°à¥‹à¤² à¤…à¤ªà¤¨à¥‡ à¤¹à¤¾à¤¥ à¤®à¥‡à¤‚ à¤²à¥‹à¥¤</p>
    ...
    <script>
        async function executeStep(actionType) {
            ...
            if(!name || !repo) {
                alert("Project Name aur GitHub Repo URL daalà¤¨à¤¾ à¤…à¤¨à¤¿à¤µà¤¾à¤°à¥à¤¯ à¤¹à¥ˆ!");
                return;
            }
            ...
            try {
                ...
                if(data.status === "success") {
                    res.innerHTML = "âœ… <b>Success (" + actionType.toUpperCase() + "):</b><br>" + data.message + 
                                    (data.download_url ? "<br><br><a href='"+data.download_url+"' style='color:#34d399; font-size:16px;' target='_blank'><b>ðŸ“¥ Direct Download APK Here</b></a>" : "");
                } else if(data.status === "error") {
                    res.innerText = "âŒ Error: " + data.message;
                } else {
                    res.innerText = "â„¹ï¸ Result:\n" + JSON.stringify(data, null, 2);
                }
            } catch(err) {
                res.innerText = "âŒ Network Error: " + err.message;
            }
        }
    </script>
</body>
...
func StartServer() {
	...
	http.HandleFunc("/api/run", func(w http.ResponseWriter, r *http.Request) {
		...
		if err := json.NewDecoder(r.Body).Decode(&p); err != nil {
			// à¤¯à¤¹à¤¾à¤ à¤¸à¤¹à¥€ à¤¤à¤°à¥€à¤•à¤¾ à¤¹à¥ˆ json.NewEncoder(w).Encode à¤²à¤—à¤¾à¤¨à¤¾
